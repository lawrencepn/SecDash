...
angular.module('secDash.dashboard', ['ngMaterial'])
        ...
        return {
            ...
            link: function (scope, iElm, iAttrs, controller) {
                ...
                scope.component_progress = function (tag) {
                    ...
                    }else if(jira_id == null){
                        //let the user know, there is no jira task for this item
                        scope.no_jira_task = true;
                        //show a modal
    ...
    .directive('africamap', ['$mdSidenav', function ($mdSidenav) {
        return {
            scope: {country: '&'},
            restrict: 'E',
            templateUrl: "dashboard/africa_map.html",
            replace: true,
            link: function (scope, iElm, iAttrs, controller) {
                ...
                scope.country_summary = {};

                d3.json(url, function (error, africa) {
                    if (error) throw error;

                    //add flags as patterns to apply
                    svg.append("g")
                        ...
                        .on("click", function (d, i) {
                            ...
                            // scope.country_summary = d.properties;
                            // scope.country_summary['flag'] = "/images/country-flags/" + d.properties.geounit + ".jpg";
                        })
                        ...
                        .on('mouseout', function () {
                            scope.country_summary = null;
                            scope.country_summary['flag'] = null;
                            scope.$applyAsync();
                        })
                        ...
                        .attr("xlink:href", function (d) {
                            return "../images/country-flags/" + d.properties.geounit + ".jpg"
                        })
                        .attr('width',259)
                        .attr('height',194)
                        .attr('x',-9)
